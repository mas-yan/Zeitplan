      ...
      <section>
        <div className={`flex relative flex-col-reverse lg:flex-row mt-12 lg:mt-20 ${addH}`}>
          <div className="lg:w-1/2 ">
            <p className="items-center justify-center md:text-center lg:text-left font-patua font-normal text-4xl md:text-5xl md:w-12/12 lg:w-9/12 2xl:w-7/12 leading:[20px] md:leading-[60px] text-dark-500">Sebuah cara mudah mengatur jadwal kuliah kamu</p>
            <div className='font-sans md:w-12/12 2xl:w-3/5 md:text-center lg:text-left mt-4 leading-[24px] md:leading-[34px] text-[0.85rem] md:text-lg md:font-normal  text-dark-500 text-opacity-60'>
