export default function CardReview(props) {
    return(
        <div className="bg-white shadow-xl w-[469px] p-[30px] shadow-primary-500/20 rounded-md">
            ...
            <div className="flex">
            <img src={props.image} className="rounded-full mr-5" style={{'width': '55px', 'height': '55px'}} alt="star" />
            <div>
